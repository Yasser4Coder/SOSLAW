      ...
      <div className="min-h-screen bg-[#f5f5f5]">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-[#09142b] mb-6">
          ...
          <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-200 mb-16">
            <div className="text-center mb-8">
              <h2 className="text-2xl font-bold text-[#09142b] mb-4">
            ...
            <div className="max-w-2xl mx-auto">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium text-[#09142b]">
                  {t("libraryProgressLabel", "Development Progress")}
                </span>
                <span className="text-sm font-medium text-[#c8a45e]">75%</span>
              </div>
